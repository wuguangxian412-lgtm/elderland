...
class MagicDialog extends StatelessWidget {
  const MagicDialog({super.key});

  static Future<void> show(BuildContext context) {
    return showDialog(context: context, builder: (_) => const MagicDialog());
  }
    ...
    final content = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (tight)
            _magicGrid(itemCount: itemCount, rows: rows, scrollable: scrollable)
          else
            Expanded(
              child: _magicGrid(
                itemCount: itemCount,
